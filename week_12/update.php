...
<?php
	...
	try
	{
		...
		echo '<link href="week_12/css/style.css" rel="stylesheet" type="text/css" />';
		echo "<div class='success'>";
		echo "<p>Account info updated.</p>";
		echo "<p>You will be redirected to the admin page in 5 seconds, or click <a href='week_12/admin.php'>here</a></p>";
		echo "</div>";
	}
